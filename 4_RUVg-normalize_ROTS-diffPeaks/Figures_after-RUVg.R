...
AllResults_g <- "Figures_after-RUVg/1_batch"
...
AllResults_g <- "Figures_after-RUVg/2_disease-state"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
AllResults_g <- "Figures_after-RUVg/3_Gender"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
AllResults_g <- "Figures_after-RUVg/4_Race"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
AllResults_g <- "Figures_after-RUVg/5_Age"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
AllResults_g <- "Figures_after-RUVg/6_Smoking"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
AllResults_g <- "Figures_after-RUVg/7_EGFRmutation"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
