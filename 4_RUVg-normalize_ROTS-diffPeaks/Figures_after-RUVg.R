...
###########################################################################################################################################################################
rawMatrix_1 <- read.table("6G.log2.normalizedCounts.withHeader.txt", header=TRUE,   sep="\t", comment.char = "" )    
...
AllResults_g <- "Figures_before-RUVg/1_batch"
...
MyBoxViolinPlot_1_f(vector2=my_vector_temp,   sampleType2=my_sampleType_temp2,  path2=AllResults_g,   fileName2="1.one-feature-as-type",  
                    title2="",  xLab2="Sample types",  yLab2="log2(5hmC level)",    height2=5,   width2=5,   Ymin2= 0, Ymax2=7) 
...
MyBoxViolinPlot_1_f_each(vector2=my_vector_temp,   sampleType2=my_sampleType_temp3,  path2=AllResults_g,   fileName2="2.each-sample",  
                    title2="",  xLab2="Samples",  yLab2="log2(5hmC level)",    height2=5,   width2=20,   Ymin2= 0, Ymax2=7) 
...
MyBoxViolinPlot_3_f(vector2=my_vector_temp,   sampleType3= my_sampleType_temp1,  sampleType4= my_sampleType_temp2,  
                    ...
                    title2="",  xLab2="Samples",  yLab2="log2(5hmC level)",    height2=5,   width2=7,   Ymin2= 0, Ymax2=7 )
...
MyBoxViolinPlot_3_f(vector2=my_vector_temp,   sampleType3= my_sampleType_temp2,  sampleType4= my_sampleType_temp1,  
                    ...
                    title2="",  xLab2="Samples",  yLab2="log2(5hmC level)",    height2=5,   width2=5,   Ymin2= 0, Ymax2=7 )
...
MyBoxViolinPlot_3A_f(vector2=my_vector_temp,   sampleType3= my_sampleType_temp2,  sampleType4= my_sampleType_temp3,  
                    ...
                    title2="",  xLab2="Samples",  yLab2="log2(5hmC level)",    height2=5,   width2=22,   Ymin2= 0, Ymax2=7 )



## PCA
library(factoextra)
prcompObj2         <- prcomp(t(myRPKM2), scale = FALSE )
...
MyMultidimensionalScaling_1_g( meLevelMatrix2=myRPKM2,        path2=paste(AllResults_g, "MDS_Results", sep="/"),   dataFrame_temp2=dataFrame_temp2 )
myHierarchicalClustering_1_g(  mat_3three    =myRPKM2,   path_temp1=paste(AllResults_g, "Hierarchical", sep="/"),  width1=15, height1=6,  groups1 = my_col_names2  )
...
pdf( file = paste(AllResults_g, "1.HierarchicalClustering.heatmap.pdf", sep="/"),  width=7, height=8  )
...
pdf( file = paste(AllResults_g, "1.HierarchicalClustering.heatmap.cluster.pdf", sep="/"),  width=7, height=7  )
...
AllResults_g <- "Figures_before-RUVg/2_disease-state"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
MyBoxViolinPlot_1_f(vector2=my_vector_temp,   sampleType2=my_sampleType_temp2,  path2=AllResults_g,   fileName2="1.one-feature-as-type",  
                    title2="",  xLab2="Sample types",  yLab2="log2(5hmC level)",    height2=5,   width2=4,   Ymin2= 0, Ymax2=7) 
...
MyBoxViolinPlot_3_f(vector2=my_vector_temp,   sampleType3= my_sampleType_temp1,  sampleType4= my_sampleType_temp2,  
                    path2=AllResults_g,   fileName2="3a",  
                    title2="",  xLab2="Samples",  yLab2="log2(5hmC level)",    height2=5,   width2=4,   Ymin2= 0, Ymax2=7 )
...
AllResults_g <- "Figures_before-RUVg/3_Gender"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
AllResults_g <- "Figures_before-RUVg/4_Race"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
AllResults_g <- "Figures_before-RUVg/5_Age"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
MyBoxViolinPlot_1_f(vector2=my_vector_temp,   sampleType2=my_sampleType_temp2,  path2=AllResults_g,   fileName2="1.one-feature-as-type",  
                    title2="",  xLab2="Sample types",  yLab2="log2(5hmC level)",    height2=5,   width2=15,   Ymin2= 0, Ymax2=7) 
...
MyBoxViolinPlot_3_f(vector2=my_vector_temp,   sampleType3= my_sampleType_temp1,  sampleType4= my_sampleType_temp2,  
                    path2=AllResults_g,   fileName2="3a",  
                    title2="",  xLab2="Samples",  yLab2="log2(5hmC level)",    height2=5,   width2=15,   Ymin2= 0, Ymax2=7 )
...
AllResults_g <- "Figures_before-RUVg/6_Smoking"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
AllResults_g <- "Figures_before-RUVg/7_EGFRmutation"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
