...
###########################################################################################################################################################################
rawMatrix_1 <- read.table("Kept.info.txt", header=TRUE,   sep="\t", comment.char = "" )    
dim( rawMatrix_1 )
...
AllResults_g <- "For_deeptools.1/1_batch"
...
MyBoxViolinPlot_3_f(vector2=my_vector_temp,   sampleType3= my_sampleType_temp2,  sampleType4= my_sampleType_temp3,  
                    path2=AllResults_g,   fileName2="4",  
...
AllResults_g <- "For_deeptools.1/2_disease-state"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
AllResults_g <- "For_deeptools.1/3_Gender"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
AllResults_g <- "For_deeptools.1/4_Race"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }
...
AllResults_g <- "For_deeptools.1/5_Age"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }

my_col_names1 = as.vector(unlist(myHeader[5,] ) )  ## ctrl, unctrl
my_col_names2 = as.vector(unlist(myHeader[10,] ) )  ##### Age
my_col_names3 = as.vector(unlist(myHeader[6,] ) )  ## name for each sample
length( my_col_names1 )
length( my_col_names2 )
length( my_col_names3 )
...
AllResults_g <- "For_deeptools.1/6_Smoking"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }

my_col_names1 = as.vector(unlist(myHeader[5,] ) )  ## ctrl, unctrl
my_col_names2 = as.vector(unlist(myHeader[12,] ) )  ##### Smoking
my_col_names3 = as.vector(unlist(myHeader[6,] ) )  ## name for each sample
length( my_col_names1 )
length( my_col_names2 )
length( my_col_names3 )
...
AllResults_g <- "For_deeptools.1/7_Smoking"
if( ! file.exists(AllResults_g) ) { dir.create(path=AllResults_g, recursive = TRUE) }

my_col_names1 = as.vector(unlist(myHeader[5,] ) )  ## ctrl, unctrl
my_col_names2 = as.vector(unlist(myHeader[13,] ) )  ##### Smoking
my_col_names3 = as.vector(unlist(myHeader[6,] ) )  ## name for each sample
length( my_col_names1 )
length( my_col_names2 )
length( my_col_names3 )
