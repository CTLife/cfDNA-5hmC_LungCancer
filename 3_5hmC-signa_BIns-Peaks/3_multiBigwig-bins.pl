...
my $output_g = '';  ## such as "3_multiBigwig-bins"
...
my $HELP = '
        ...
        ------------------------------------------------------------------------------------------------------------------------------------------------------
        Usage:
               perl  3_multiBigwig-bins.pl    [-version]    [-help]      [-in inputDir]    [-out outDir]
        For instance:
               nohup  time  perl  3_multiBigwig-bins.pl    -in B1_BW   -out 3_multiBigwig-bins    > 3_multiBigwig-bins.runLog.txt  2>&1  &
...
$output_g = '3_multiBigwig-bins';  ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl  3_multiBigwig-bins.pl  -help' \n";
    exit 0;
}
